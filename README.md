<img src="https://capsule-render.vercel.app/api?type=waving&height=200&color=gradient&customColorList=6,11,20,29&text=Ayesha%20Naveed&fontSize=48&fontColor=fff&animation=twinkling&fontAlignY=35&desc=Frontend%20Engineer&descSize=18&descAlignY=55&textBg=false"/>

<p align="center">
  <a href="https://komarev.com/ghpvc/?username=clockworkaiesh">
    <img src="https://komarev.com/ghpvc/?username=clockworkaiesh&label=Profile%20views&color=00FFFF&style=flat-square" alt="clockworkaiesh's profile views" />
  </a>
</p>
...
### 🚀 **About Me**
I'm a passionate **Frontend Developer** specializing in **React, Next.js, and TypeScript**. I love transforming beautiful designs into high-performance, scalable web applications with pixel-perfect precision.

- 🔭 **Currently:** Senior Frontend Developer at **TechThree** (Remote)
- 🌱 **Learning:** Advanced Web3 integrations & performance optimization patterns
- 💬 **Ask me about:** React, Next.js, TypeScript, Tailwind, or turning Figma designs into code
- ⚡ **Fun fact:** I once reduced load times by **35%** through code splitting & lazy loading
- 📫 **How to reach me:** `ayeshanaved23@gmail.com` | [+92 308 1479194](tel:+923081479194)
...
|---------|------------|--------|
| **D3.js Data Visualizations** | React, D3.js, TypeScript | Built interactive bubble maps & charts for complex datasets |
| **Web3 dApp Integrations** | React, MetaMask, WebSocket | Integrated real-time blockchain data syncing |
| **Performance Optimization** | Next.js, Code Splitting | Reduced load times by **35%** |
...
- **🌐 Modern Web Tech** – Web3, real-time data (WebSocket), data visualization (D3.js)
- **🔄 Scalable Architecture** – Reusable components, design systems, modular code
- **🤝 Team Collaboration** – Agile/Scrum, code reviews, mentoring junior developers
...
[![Portfolio](https://img.shields.io/badge/Portfolio-View%20My%20Work-FF7139?style=for-the-badge&logo=vercel&logoColor=white)](https://www.ayesha-naveed.space)
...
> *"Turning complex problems into elegant, user-friendly solutions — one component at a time."*
